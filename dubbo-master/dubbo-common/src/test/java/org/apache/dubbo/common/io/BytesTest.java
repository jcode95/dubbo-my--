...
public class BytesTest {
    ...
    @Test
    public void testta(){
        String mapStr="{1:{170153:[1572434435,0]}}";
        if (!mapStr.equals(StringUtils.EMPTY)) {
            Map<Integer, Map<Integer, Long[]>> s= (Map<Integer, Map<Integer, Long[]>>) JSONObject.parse(mapStr);
            Map<Integer,  Map<Integer, Long[]>> parseObject = JSONObject.parseObject(mapStr, Map.class);
